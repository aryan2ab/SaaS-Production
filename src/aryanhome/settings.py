"""
Django settings for aryanhome project.
...
WSGI_APPLICATION = 'aryanhome.wsgi.application'
...
ACCOUNT_EMAIL_SUBJECT_PREFIX = "[AryanHome] "
...
STATICFILES_BASE_DIR.mkdir(exist_ok=True, parents = True) #ensure the base dir exists
